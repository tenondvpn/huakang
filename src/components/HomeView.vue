<template>
  <el-empty style="margin-top: 100px;">
    ...
    <el-button v-if="is_processor" size="large" type="primary" :icon="Plus" @click="crate_pipeline">创建模板指令</el-button>
    <el-button v-else size="large" type="primary" :icon="Plus" @click="crate_pipeline">创建监控指令</el-button>
  </el-empty>
</template>
